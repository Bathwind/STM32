...
//		LED0=!LED0;//DS0闪烁
	 ...
	 while(1)
	 {
		 ...
		 if(key)
		 {
			  switch(key)
			  {
				  case KEY1_PRES:  vl53l0x_calibration_test(&vl53l0x_dev);   break;//校准模式
				  case WKUP_PRES:  vl53l0x_general_test(&vl53l0x_dev);       break;//普通测量模式
...
{
	vl53l0x_set_mode(&vl53l0x_dev,1);
