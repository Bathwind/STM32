...
void EXTI15_10_IRQHandler(void)
{
  ...
  { 
     EXTI_ClearITPendingBit(EXTI_Line11); //清除 LINE 上的中断标志位
		 ...
		 {
			led1 = 0;
			TIM_SetCompare1(TIM1,233);
		 }
		 if(tube7 == 0&&point == 6)//用来控制风扇将转速降低到达第六个光电管
		 {
			led1 = 0;
			TIM_SetCompare1(TIM1,229);
		 }
		 if(tube7 == 0&&point == 7)//用来控制风扇将转速降低到达第六个光电管
		 {
			led1 = 0;
...
void Control_point(int n)
{
		switch(n)
		{
			...
			case 8:
				TIM_SetCompare1(TIM1,320);break;//到达第八个光电管
			case 9:
 				TIM_SetCompare1(TIM1,320);break;//到达第九个光电管            
			case 10:
 				TIM_SetCompare1(TIM1,320);break;//到达第十个光电管
			case 11:
				TIM_SetCompare1(TIM1,320);break;//到达第十一个光电管
			case 12:
 				TIM_SetCompare1(TIM1,320);break;//到达第十二个光电管
			case 13:
 				TIM_SetCompare1(TIM1,266);break;//到达第十三个光电管
			case 14:
