...
//IO方向设置
#define VL_SDA_IN()  {GPIOB->CRL&=0XFFFF0FFF;GPIOB->CRL|=8<<12;}
#define VL_SDA_OUT() {GPIOB->CRL&=0XFFFF0FFF;GPIOB->CRL|=3<<12;}


//IO操作函数	 
#define VL_IIC_SCL    PBout(4)      //SCL
#define VL_IIC_SDA    PBout(3) 		//SDA	 
#define VL_READ_SDA   PBin(3) 		//输入SDA 
