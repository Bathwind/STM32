   ...
   switch(height)
	 {
      ...
      height_I = 0.014;//pid的i系数
		 ...
		 {
		  target = 150;//目标高度//B点
		  height_P = 1.444;//pid的p系数
      height_I = 0.023;//pid的i系数
		 }
		 break;
		 case 3:
		 {
			target = 200;//目标高度//C点
		  height_P = 0.994;//pid的p系数
      height_I = 0.011;//pid的i系数
	   ...
	   case 4:
		 {
			target = 250;//目标高度//D点
		  height_P = 0.885;//pid的p系数
      height_I = 0.0099;//pid的i系数
		 }
		 break;
		 case 5:
		 {
